...
# def get_alpha(df):
#         alpha=Alphas(df)
#         df['alpha001']=alpha.alpha001()
#         df['alpha002']=alpha.alpha002()
#         df['alpha003']=alpha.alpha003()
#         df['alpha004']=alpha.alpha004()
#         df['alpha005']=alpha.alpha005()
#         df['alpha006']=alpha.alpha006()
#         df['alpha007']=alpha.alpha007()
#         df['alpha008']=alpha.alpha008()
#         df['alpha009']=alpha.alpha009()
#         df['alpha010']=alpha.alpha010()
#         df['alpha011']=alpha.alpha011()
#         df['alpha012']=alpha.alpha012()
#         df['alpha013']=alpha.alpha013()
#         df['alpha014']=alpha.alpha014()
#         df['alpha015']=alpha.alpha015()
#         df['alpha016']=alpha.alpha016()
#         df['alpha017']=alpha.alpha017()
#         df['alpha018']=alpha.alpha018()
#         df['alpha019']=alpha.alpha019()
#         df['alpha020']=alpha.alpha020()
#         df['alpha021']=alpha.alpha021()
#         df['alpha022']=alpha.alpha022()
#         df['alpha023']=alpha.alpha023()
#         df['alpha024']=alpha.alpha024()
#         df['alpha025']=alpha.alpha025()
#         df['alpha026']=alpha.alpha026()
#         df['alpha027']=alpha.alpha027()
#         df['alpha028']=alpha.alpha028()
#         df['alpha029']=alpha.alpha029()
#         df['alpha030']=alpha.alpha030()
#         df['alpha031']=alpha.alpha031()
#         df['alpha032']=alpha.alpha032()
#         df['alpha033']=alpha.alpha033()
#         df['alpha034']=alpha.alpha034()
#         df['alpha035']=alpha.alpha035()
#         df['alpha036']=alpha.alpha036()
#         df['alpha037']=alpha.alpha037()
#         df['alpha038']=alpha.alpha038()
#         df['alpha039']=alpha.alpha039()
#         df['alpha040']=alpha.alpha040()
#         df['alpha041']=alpha.alpha041()
#         df['alpha042']=alpha.alpha042()
#         df['alpha043']=alpha.alpha043()
#         df['alpha044']=alpha.alpha044()
#         df['alpha045']=alpha.alpha045()
#         df['alpha046']=alpha.alpha046()
#         df['alpha047']=alpha.alpha047()
#         df['alpha049']=alpha.alpha049()
#         df['alpha050']=alpha.alpha050()
#         df['alpha051']=alpha.alpha051()
#         df['alpha052']=alpha.alpha052()
#         df['alpha053']=alpha.alpha053()
#         df['alpha054']=alpha.alpha054()
#         df['alpha055']=alpha.alpha055()
#         df['alpha057']=alpha.alpha057()
#         df['alpha060']=alpha.alpha060()
#         df['alpha061']=alpha.alpha061()
#         df['alpha062']=alpha.alpha062()
#         df['alpha064']=alpha.alpha064()
#         df['alpha065']=alpha.alpha065()
#         df['alpha066']=alpha.alpha066()
#         df['alpha068']=alpha.alpha068()
#         df['alpha071']=alpha.alpha071()
#         df['alpha072']=alpha.alpha072()
#         df['alpha073']=alpha.alpha073()
#         df['alpha074']=alpha.alpha074()
#         df['alpha075']=alpha.alpha075()
#         df['alpha077']=alpha.alpha077()
#         df['alpha078']=alpha.alpha078()
#         df['alpha081']=alpha.alpha081()
#         df['alpha083']=alpha.alpha083()
#         df['alpha084']=alpha.alpha084()
#         df['alpha085']=alpha.alpha085()
#         df['alpha086']=alpha.alpha086()
#         df['alpha088']=alpha.alpha088()
#         df['alpha092']=alpha.alpha092()
#         df['alpha094']=alpha.alpha094()
#         df['alpha095']=alpha.alpha095()
#         df['alpha096']=alpha.alpha096()
#         df['alpha098']=alpha.alpha098()
#         df['alpha099']=alpha.alpha099()
#         df['alpha101']=alpha.alpha101()
#         return df
...
class Alphas(object):
    ...
    def alpha006(self):
        ...
        return df.replace([-np.inf, np.inf], 0).fillna(np.NaN)
